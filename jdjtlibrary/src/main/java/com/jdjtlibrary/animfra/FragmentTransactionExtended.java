...
public class FragmentTransactionExtended implements FragmentManager.OnBackStackChangedListener {
    ...
    public void chooseTypeTransition(int transitionType) {
    ...
    public void addTransition(int transitionType) {
        chooseTypeTransition(transitionType);
        mFragmentTransaction.replace(mContainerID, mSecondFragment);
    }
    public void addTransitionStack(int transitionType) {
        chooseTypeTransition(transitionType);
...
//        mFragmentTransaction.hide(mFirstFragment);
    ...
    public void addTransitionStackFra(int transitionType,Fragment firstFragment,Fragment secondFragment) {
        chooseTypeTransition(transitionType);
        mFragmentTransaction.add(mContainerID,mSecondFragment);
        mFragmentTransaction.hide(firstFragment);
        mFragmentTransaction.show(secondFragment);
    }
